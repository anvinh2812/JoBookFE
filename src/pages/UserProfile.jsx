...
const UserProfile = () => {
    ...
    const isOwnProfile = authUser && (String(authUser.id) === String(userId));
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold text-gray-900">{user.name || user.full_name}</h1>
            ...
            <ConfirmDialog
                ...
                title="Hủy theo dõi"
                message={`Bạn có chắc muốn hủy theo dõi ${user.name || user.full_name}?`}
